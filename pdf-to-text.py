...
if platform.system() == "Windows":
    ...
    out_directory = Path(r"C:\Users\stems\PycharmProjects\scrape-data-from-pdf").expanduser()
else:
    out_directory = Path("~").expanduser()

# Path of the Input pdf
PDF_file = Path(r"source files/2017-18-Q4-Ambulance-Response-Quarter-4-FY2017-18.pdf")

# Store all the pages of the PDF in a variable
image_file_list = []

text_file = out_directory / Path("raw txt files/2017-18-Q4-Code2.txt")
    ...
    with TemporaryDirectory() as tempdir:
        ...
        if platform.system() == "Windows":
            pdf_pages = convert_from_path(
                PDF_file, 500, poppler_path=path_to_poppler_exe, first_page=10, last_page=10
            )
        else:
